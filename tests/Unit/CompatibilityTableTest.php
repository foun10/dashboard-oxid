...
namespace foun10\Dashboard\Tests\Unit;
 ...
 * not the table - is what Composer actually resolves against. The two drifted once already:
 * the OXID 7 branch advertised "^7.4 || ^8.0" while its CI ran 8.0 upwards, so a PHP 7.4 shop
...
Composer would refuse to install this module on a shop running them."
    ...
    /**
     * Only caret ranges joined by "||" are understood - the shape both branches use. Anything
